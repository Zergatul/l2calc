...
l2.data.tools.getSkill(205).effects = [
	...
	{ stat: 'pAtk', op: 'add', using: 'Blunt,Big Blunt', [3, 5.9, 8.9, 11.8, 14.8, 17.7, 20.7, 23.6, 26.6, 29.6, 32.5, 35.5, 38.4, 41.4, 44.3, 47.3, 50.2, 53.2, 56.2, 59.1, 62.1, 65, 68, 70.9, 73.9, 76.8, 79.8, 82.8, 85.7, 88.7, 91.6, 94.6, 97.5, 100.5, 103.4, 106.4, 109.4, 112.3, 115.3, 118.2, 121.2, 124.1, 127.1, 130, 133] }
];